...
void main() {
  ...
  Future<void> pumpEmailSignInForm(WidgetTester tester,
    ...
    await tester.pumpWidget(
      Provider<AuthBase>(
          create: (_) => mockAuth,
          child: Provider<EmailSignInBloc>(
            create: (context) => EmailSignInBloc(auth: mockAuth),
            child: Consumer<EmailSignInBloc>(
                builder: (_, bloc, __) => MaterialApp(
                      home: Scaffold(
                        body: EmailSignInFormBlocBased(
                            bloc: bloc, onSignedIn: onSignedIn),
                      ),
                    )),
  ...
  group('sign in', () {
    ...
    testWidgets(
      ...
      verify(mockAuth.signInWithEmailAndPassword('email@email.com', 'password'))
          .called(1);
